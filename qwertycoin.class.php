...
class Qwerty {
	 ...
	 * Keep this field empty, if don't care about security of your QWC :)
	 */
	...
	/**
	 * Decimal point, needed for QWC amount calculations
	 * (don't change this value, because it may cause loss of your QWC)
	 */
	const DECIMAL_POINT = 8;

	/**
	 * Number of decimal places
	 * (you may change this value, if price of QWC goes to high one day)
	 */
	const PREC_POINT = 4;
	...
	/**
	 * Fee of transaction
	 * (100000000 == 0.0001 QWC)
	 */
	const QWC_FEE = 100000000;
	...
	public function __construct($rpc_host = "", $rpc_port = "", $rpc_ssl = false) {
		...
		$this->service_mixin = self::QWC_MIXIN;
		$this->service_fee = self::QWC_FEE;
	 ...
	 *
	 * @param string [$address] Addres of Qwertycoin wallet
	 */
